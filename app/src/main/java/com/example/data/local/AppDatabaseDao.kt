...
interface AppDatabaseDao {
    ...
    @Query("UPDATE shepherd_file SET categoryId = :catId WHERE id = :fileId")
    suspend fun updateFileCategory(fileId: String, catId: String?)
    ...
    // --- Board Queries ---
    @Query("SELECT * FROM board ORDER BY lastModified DESC")
